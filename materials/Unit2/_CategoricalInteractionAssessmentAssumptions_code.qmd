...
```{r}
ggplot(penguins_nomiss, aes(x=________, y=__________))+
  geom_point()
```

```{r}
ggplot(penguins_nomiss, aes(x=________, y=________, color=________))+
  geom_point()+
...
where $x_1$ = bill depth (mm), and $x_2$ = 1 when sex=male, and 0 otherwise.
