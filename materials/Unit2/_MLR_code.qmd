...
-   For a car that weighs 3500 lbs and has a horsepower of 130, the predicted mpg is 18.1.
    ...
    2.  Fit a model regressing mpg on displacement, weight, acceleration, and year. Show the summary table and write interpretations for the predictor estimates (you don't need to interpret the intercept). Which predictors are