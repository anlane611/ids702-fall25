...
-   The structure of your report will differ, but you can view [this example report](ExampleReport_Factors-Associated-With-Mental-Health-in-Europe) from 2023 (shared with permission) to get an idea of formatting (e.g., hiding all code, including appropriate labels on all plots) and analysis information presented.
...
1.  Refer to [this group's report from 2023](ExampleReport_Factors-Associated-With-Mental-Health-in-Europe.pdf), which the group has kindly agreed to share.
...
-   The presentation should be focused on the motivation and results of your analysis rather than data cleaning or technical details of the model. Prioritize cre